...
const Projects = () => {
  ...
  const ProjectCard = ({ project, index }) => {
    ...
    return (
      ...
      >
        <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-200 dark:border-gray-700 hover:border-red-500/30 group-hover:scale-105 group-hover:-translate-y-2">
  ...
  return (
    <section id="proyectos" className="py-20 px-4 bg-gray-50 dark:bg-gray-900">
