import { trajectoryData } from '../../data/resumeData';
      ...
      <div className="relative">
        ...
        {trajectoryData.map((item, index) => (
          <div key={index} className="relative flex items-center mb-8">
            {/* Timeline dot */}
            <div className="absolute left-2 w-4 h-4 bg-red-500 rounded-full border-4 border-white dark:border-gray-800"></div>
